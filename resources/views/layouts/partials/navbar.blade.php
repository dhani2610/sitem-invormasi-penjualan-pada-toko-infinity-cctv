    ...
    <div class="navbar-header" style="background: black">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="background: black">
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('img/davidpsd logo.png') }}" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('img/davidpsd logo.png') }}" alt="" width="90">
                    </span>
                </a>
            </div>
        ...
        <div class="" style="background: black">
            <a href="#" class="logo logo-light">
                {{-- <span class="logo-sm">
                    <img src="{{ asset('img/davidpsd logo.png') }} " style="width: 469px;" alt="" height="50">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('img/davidpsd logo.png') }} " style="width: 469px;" alt="" width="90">
                </span> --}}
            </a>
        </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset('img/users/'.(Auth::user()->avatar ?? 'user.png')) }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 text-white" key="t-henry">{{ Str::limit(Auth::user()->name, '10', '...') }}</span>
